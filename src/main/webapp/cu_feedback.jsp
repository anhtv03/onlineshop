            ...
            <div class="row">
                ...
                <div class="col-md-8 block-right">
                    <div class="d-flex justify-content-between">
                        ...
                        <span>
                            <c:set var="href" value="cus_orderdetails?orderId=${orde.orId}"/>
                        ...
                        <span>
                            <p class="block-right__title">Đánh giá sản phẩm</p>
                        </span>
                    </div>
                    <div class="common mb-3">
                        ...
                        <div class="bill">
                            <form action="cus_feedback" method="POST">
                                <c:set value="${pro}" var="product"/>
                                <fmt:formatNumber value="${product.proPrice}" pattern="###,###" var="pricePro"/>
                                <input name="proId" value="${product.proId}" type="hidden" class="hide"/>
                                <input name="order" value="${orde.orId}" type="hidden" class="hide"/>
                                <input name="type" value="${type}" type="hidden" class="hide"/>
                                <div class="bill__product d-flex mt-1">
                                    <div class="image-product col-md-2 p-0">
                                ...
                                <div class="row gap-3">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        <textarea type="text" name="feedContent" class="feedback__content" autocomplete="off" 
                                                  placeholder="Hãy chia sẻ những điều bạn thích về sản phẩm này với những người mua khác nhé:"></textarea>
                                    </div>
                                    <div class="text-right p-3">
                                        <span class="text-red float-left pl-3">${error}</span>
                                        <button class="btn btn-feedback mr-1" type="submit" >Hoàn thành</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div id="toast" class="hide">
            <div class="toast">
                ...
                <div class="toast__body">
                    <p class="toast__body--msg">aaaa ${requestScope.status}</p>
                </div>
            </div>
        </div>
        <!--pop-up notification-->
