            ...
            <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
                ...
                <li class="menu-item">
                    ...
                    <ul id="order" class="collapse" aria-labelledby="order" data-parent="#side-nav-accordion">
                        ...
                        <li> <a href="sale_order?type=cancelled" class="active">Đơn hàng đã hủy</a>
                        </li>
                                            ...
                                            <div class="text-right mr-1">
                                                <c:if test="${pageNumber > 1}">
                                                    <a class="btn btn-page mb-1 px-2 py-1" style="min-width: 1.25rem" 
                                                       href="sale_order?type=cancelled&index=${pageNumber-1}&tilteOrder=${tilteOrder}&beginDate=${beginDate}&endDate=${endDate}&statusOrder=${statusOrder}&beginPrice=${beginPrice}&endPrice=${endPrice}">Trước</a>
                                                </c:if>
                                                    ...
                                                    <c:when test="${requestScope.endPage > 5}">
                                                        ...
                                                        <c:forEach begin="${startPage}" end="${endPage}" var="i">
                                                            <a class="btn btn-page mb-1 px-2 py-1 ${pageNumber == i ? 'active' : ''}" style="min-width: 1.25rem" 
                                                               href="sale_order?type=cancelled&index=${i}&tilteOrder=${tilteOrder}&beginDate=${beginDate}&endDate=${endDate}&statusOrder=${statusOrder}&beginPrice=${beginPrice}&endPrice=${endPrice}">${i}</a>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>
                                                ...
                                                <c:if test="${pageNumber < endPage}">
                                                    <a class="btn btn-page mb-1 px-2 py-1" style="min-width: 1.25rem" 
                                                       href="sale_order?type=cancelled&index=${pageNumber+1}&tilteOrder=${tilteOrder}&beginDate=${beginDate}&endDate=${endDate}&statusOrder=${statusOrder}&beginPrice=${beginPrice}&endPrice=${endPrice}">Sau</a>
                                                </c:if>
                                            </div>
                                        </div>
                                        <!--End Pagination-->
