...
<html lang="en">
    <head>
        ...
        <title>Ðơn hàng đang giao</title>
            ...
            <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
                ...
                <li class="menu-item">
                    ...
                    <ul id="order" class="collapse" aria-labelledby="order" data-parent="#side-nav-accordion">
                        ...
                        <li> <a href="sale_order?type=delivering" class="active">Đơn hàng đang giao</a>
                        </li>
                    </ul>
                </li>
                <!-- order -->
                            ...
                            <div class="ms-panel">
                                ...
                                <div class="ms-panel-header filter" style="border-bottom: 0;padding-bottom: 0;">
                                    ...
                                    <form action="sale_order" method="GET">
                                        <input type="hidden" name="type" value="delivering"/>
                                            ...
                                            <div class="text-right mr-1">
                                                <c:if test="${pageNumber > 1}">
                                                    <a class="btn btn-page mb-1 px-2 py-1" style="min-width: 1.25rem" 
                                                       href="sale_order?type=delivering&index=${pageNumber-1}&tilteOrder=${tilteOrder}&beginDate=${beginDate}&endDate=${endDate}&statusOrder=${statusOrder}&beginPrice=${beginPrice}&endPrice=${endPrice}">Trước</a>
                                                </c:if>
                                                    ...
                                                    <c:when test="${requestScope.endPage > 5}">
                                                        ...
                                                        <c:forEach begin="${startPage}" end="${endPage}" var="i">
                                                            <a class="btn btn-page mb-1 px-2 py-1 ${pageNumber == i ? 'active' : ''}" style="min-width: 1.25rem" 
                                                               href="sale_order?type=delivering&index=${i}&tilteOrder=${tilteOrder}&beginDate=${beginDate}&endDate=${endDate}&statusOrder=${statusOrder}&beginPrice=${beginPrice}&endPrice=${endPrice}">${i}</a>
                                                        </c:forEach>
                                                    </c:when>
                                                    <c:otherwise>
                                                ...
                                                <c:if test="${pageNumber < endPage}">
                                                    <a class="btn btn-page mb-1 px-2 py-1" style="min-width: 1.25rem"
                                                       href="sale_order?type=delivering&index=${pageNumber+1}&tilteOrder=${tilteOrder}&beginDate=${beginDate}&endDate=${endDate}&statusOrder=${statusOrder}&beginPrice=${beginPrice}&endPrice=${endPrice}">Sau</a>
                                                </c:if>
                                            </div>
                                        </div>
                                        <!--End Pagination-->
