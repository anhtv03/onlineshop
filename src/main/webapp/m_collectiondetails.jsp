...
<html lang="en">
  ...
  if (confirm("Bạn có chắc chắn bộ sưu tập này?")) {
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb pl-0">
                                ...
                                <li class="breadcrumb-item"><a href="mkt_productlist">Danh sách bộ sưu tập</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Chi tiết Bộ sưu tập</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="my-3 mx-4" ><a href="mkt_collectionlist"><i class="fa fa-chevron-circle-left" style="font-size: 2rem;" aria-hidden="true"></i></a></div>
                    <div class="col-md-12">
                        <div class="ms-panel">
                            <c:set var="c" value="${collection}"/>

                            <div class="ms-panel-header">
                                <h6>Chi tiết bộ sưu tập</h6>
                            </div>
                            ...
                            <div class="ms-panel-body">
                                ...
                                <div id="arrowSlider" class="ms-arrow-slider carousel slide" data-ride="carousel" data-interval="false">
                                    <div class="carousel-inner">
                                        <c:set var="newsId" value="${newsId}" />
                                        <fmt:parseNumber var="IdParsed" type="number" value="${newsId}" />
                                        <c:set var="newsImgUrl1" value="${News.getById(IdParsed).newsImgUrl}" />
                                        <img class="d-block w-100"  src="${newsImgUrl1}" alt="Slider" style="height: 550px;">
                                    </div>
                    ...
                    <div class=" col-md-6">
                        <div class="ms-panel ms-panel-fh">
                            <div class="ms-panel-body">
                                <h4 class="section-title bold">Điền thông tin bộ sưu tập</h4>

                                <table class="table ms-profile-information">
                                    <tbody>

                                    <form id="deleteForm" action="mkt_collectionlist" method="post">




                                        <tr>
                                            <th scope="row">Thêm tiêu đề</th>
                                            <td>
                                                <input class="form-control" type="text" name="collectionTitle" placeholder="Nhập tiêu đề" value="${c.collectionTitle}" required>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select class="form-control" name="collectionStatus">
                                                    <option class="text-success" value="on" ${c.collectionStatus eq checkon ? "selected" : ""}>Hoạt động</option>            
                                                    <option class="text-danger" " value="off" ${c.collectionStatus eq checkoff ? "selected" : ""}>Dừng bán</option>
                                                </select>
                                            </td>
                                        </tr>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="ms-panel ms-panel-fh">                            
                            <div class="ms-panel-body">
                                <h4 class="section-title bold text-center my-4">Chọn slider và sản phẩm</h4>
                                <div class="chooseProAndSlider--fixUI col-lg-12 my-3">
                                    <div class="input-group col-lg-6 justify-content-center">
                                        <button type="submit" class="btn btn-outline-info" name="handleColDe" value="chooseSlider">Thay đổi slider</button>

                                    </div>
                                    <div class="input-group col-lg-6 justify-content-center border-left">
                                        <button type="submit" class="btn btn-outline-info" name="handleColDe" value="chooseProduct">Thay đổi sản phẩm</button>
                                    </div>

                                </div>


                                <div><h6 class="text-danger text-center">${errorSlider}</h6></div>
                                <div><h6 class="text-danger text-center">${errorProduct}</h6></div>


                                <div class="col-lg-12 text-center">
                                    <button  name="handleColDe" value="reviewListSel" class="btn btn-info mx-5">Danh sách sản phẩm đã chọn</button>
                                </div>
                                <input type="hidden" name="collectionId" value="${c.collectionId}" />
                    ...
                    <div class="col-lg-12 text-center">
                        <button type="submit" name="handleColDe" value="update" class="btn btn-success mx-5">Chỉnh sửa</button>
                        <button type="submit" name="handleColDe" value="delete" onclick="doDelete('${c.collectionId}')" class="btn btn-danger mx-5">Xóa</button>
                    </div>
                    </form>
            ...
            <div id="toast" class="${status == 'success' ? '' : 'hide'}">
                <div class="toast">
                    ...
                    <div class="toast__body">
                        <p class="toast__body--msg">Chỉnh sửa bộ sưu tập thành công</p>
                    </div>
                </div>
            </div>
            <!--pop-up notification-->
