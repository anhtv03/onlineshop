      ...
      <!-- Sidebar Navigation Left Begin -->
        ...
        <main class="body-content">
            ...
            <div class="ms-content-wrapper">
                ...
                <p class="common__title">Nhập title bài viết</p>
                <textarea class="form-control" id="title" name="title" cols="160" style="height: 2.5rem;"></textarea>
                <br>
                <br>
                <p class="common__title">Chọn ảnh cho bài viết</p>
                <textarea type="file" id="imageInput" name="imageInput"></textarea>
                <br>
                <br>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-2 d-flex justify-content-end">
                        <button type="button" class="btn__createdPost col-md-10" onclick="sendContentToServlet()" >Tạo bài viết</button>
                    </div>
                </div>
                ...
                <script>
                    ...
                    function sendContentToServlet() {
                        ...
                        xhr.open('post', 'mkt_postcreate', true);
                        ...
                        var data = 'title=' + encodeURIComponent(title) + '&content=' + encodeURIComponent(content) + '&image=' + encodeURIComponent(image);
                        xhr.send(data);
                    }
            ...
            <div id="toast" class="hide">
                <div class="toast">
                    ...
                    <div class="toast__body">
                        <p class="toast__body--msg">Đăng bài thành công</p>
                    </div>
                </div>
            </div>
            <!--pop-up notification-->  
