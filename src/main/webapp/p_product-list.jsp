...
<html>
    <head>
        ...
        <meta content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=5, user-scalable=1"
              name="viewport" />
        <title>${requestScope.catePro.cateProName}
            <c:if test="${requestScope.cateProDe != null}">
                | ${requestScope.cateProDe.cateProDeName}
            </c:if>
        </title>
    ...
    <body style="font-family: Manrope">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb__links">
                            ...
                            <a href="pub_viewproductlistbycategory?CategoryProductDetailsId=0&CategoryProductId=${requestScope.catePro.cateProId}"> ${requestScope.catePro.cateProName}</a>        
                            <a href="pub_viewproductlistbycategory?CategoryProductDetailsId=${categoryProductDetailsId}&CategoryProductId=${categoryProductId}"> ${requestScope.cateProDe.cateProDeName}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="searching--msg">
            <h3 style="text-align: center">${msgFound}</h3>
        </div>
        <!-- Msg Search End -->
        ...
        <div class="container-fluid my-4" style="padding:0";>
            <div class="row">
                <div class="col-lg-3 filter--all">
                    <div class="filter mx-5">
                        <div class="filter--category my-2">
                            <p>Danh mục sản phẩm</p>
                            <div class="filter--namecatedetails">                  
                                <h4>
                                    <span><i class="bi bi-tags-fill"></i></span> <a href="pub_viewproductlistbycategory?CategoryProductDetailsId=0&CategoryProductId=${requestScope.catePro.cateProId}"> <span>${requestScope.cateProduct.cateProName}</span></a>
                                </h4>
                            </div>
                            <div>
                                <ul>
                                    <c:forEach items="${requestScope.listCateProDetails}" var="lcpd">
                                        <li class="mb-2">
                                            <a href="pub_viewproductlistbycategory?CategoryProductDetailsId=${lcpd.cateProDeId}&CategoryProductId=${lcpd.cateProId}">
                                                <span><i class="bi bi-play-fill"></i></span>
                                                <span>${lcpd.cateProDeName}</span>
                                            </a>
                                        </li>  
                                    </c:forEach>
                                </ul>
                        ...
                        <div class="filter--category my-3">
                            <p>Giá sản phẩm</p>
                            <form id="dosearch" action="pub_filterpriceandsizeproduct" method="post">
                                <div>
                                    <div>

                                        <ul>
                                            <li>
                                                <input type="radio" class="filter--price my-3" name="filterPrice" id="under100" ${checkPrice eq '0 AND 100000'?'checked':''} value="0 AND 100000" onchange="change()"> <label for="under100">Dưới 100,000</label>                             
                                            </li>
                                            <li>
                                                <input type="radio" class="filter--price my-3" name="filterPrice" id="100-200" ${checkPrice eq '100000 AND 200000'?'checked':''} value="100000 AND 200000" onchange="change()"> <label for="100-200">Từ 100,000 - 200,000</label>
                                            </li>
                                            <li>
                                                <input type="radio" class="filter--price my-3" name="filterPrice" id="200-300" ${checkPrice eq '200000 AND 300000'?'checked':''} value="200000 AND 300000" onchange="change()"> <label for="200-300">Từ 200,000 - 300,000</label>
                                            </li>
                                            <li>
                                                <input type="radio" class="filter--price my-3" name="filterPrice" id="300-500" ${checkPrice eq '300000 AND 500000'?'checked':''} value="300000 AND 500000" onchange="change()"> <label for="300-500">Từ 300,000 - 500,000</label>
                                            </li>
                                            <li>
                                                <input type="radio" class="filter--price my-3" name="filterPrice" id="500-1000" ${checkPrice eq '500000 AND 1000000'?'checked':''} value="500000 AND 1000000" onchange="change()"> <label for="500-1000">Từ 500,000 - 1,000,000</label>
                                            </li>
                                            <li>
                                                <input type="radio" class="filter--price my-3" name="filterPrice" id="over1000" ${checkPrice eq '1000000 AND 10000000'?'checked':''} value="1000000 AND 10000000" onchange="change()"> <label for="over1000">Trên 1,000,000</label>
                                            </li>
                                        </ul>

                                        <input type="hidden" name="CategoryProductId" value="${categoryProductId}"/>
                                        <input type="hidden" name="CategoryProductDetailsId" value="${categoryProductDetailsId}"/>
                                    </div>
                ...
                <div class="col-lg-9">
                    <div class="row mx-3">
                        ...
                        <c:choose>
                            <c:when test="${checkPrice eq null || checkPrice eq check}" >
                                <form id="submitPage" action="pub_viewproductlistbycategory" method="get">
                                    <div class="col-lg-12 my-4">
                                        <nav aria-label="">
                                            <ul class="pagination pagination-sm">
                                                <c:forEach begin="1" end="${endPage}" var="i">
                                                    <li class="page-item ${tag == i?"active":""}" aria-current="page" >
                                    ...
                                    <input type="hidden" name="filterPrice" value="${checkPrice}"/>
                                    <input type="hidden" name="CategoryProductId" value="${categoryProductId}"/>
                                    <input type="hidden" name="CategoryProductDetailsId" value="${categoryProductDetailsId}"/>
                            ...
                            <c:otherwise>
                                <form id="submitPage" action="pub_filterpriceandsizeproduct" method="post">
                                    <div class="col-lg-12 my-4">
                                        <nav aria-label="">
                                            <ul class="pagination pagination-sm">
                                                <c:forEach begin="1" end="${endPage}" var="i">
