                                        ...
                                        <ul class="list-group list-group-payment list-payment">
                                            <li class="list-group-item">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="payment-box">
                                                        <div class="form-check">
                                                            <input type="radio" id="PaymentID14190" class="form-check-input" name="Payment" data-id="14190" value="direct"
                                                            <c:if test="${choicePay eq 'direct'}">checked</c:if> >
                                                        </div>
                                                        <img class="ic" src="https://nimdo.vn/upload/news/chinh-sach-thanh-toan-8663.png" alt="Thanh toán Ví Momo">
                                                        <label for="PaymentID14190">Thanh toán khi nhận hàng</label>
                                                    </div>
                                                </li>
