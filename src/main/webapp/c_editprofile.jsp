                ...
                <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
                    ...
                    <li class="menu-item">
                        <a href="ad_dashboard"> <span><i class="fas fa-columns"
                                                         style="width: 14px; height: 14px;"></i>Dashboard</span>
                        </a>
                    </li>
                    <!-- /Dashboard -->
                    ...
                    <!-- register account -->
                    <li class="menu-item">
                        <a href=""> <span><i class="fas fa-user-plus"
                    ...
                    <main class="body-content">
                        ...
                        <div class="ms-content-wrapper">
                            <div class="block-right">
                                <p class="block-right__title">Chỉnh sửa thông tin cá nhân</p>
                                ...
                                <form action="com_upprofile" method="post">
                                    <div class="row">
                                        <div class="common mb-3 col-md-6">
                                            <p class="common__title">Họ và tên</p>
                                            <input type="text" class="form-control common__content" name="name"
                                        ...
                                        <div class="common mb-3 col-md-6">
                                            ...
                                            <input type="text" disabled class="form-control common__content" value="${account.accEmail}" />
                                            <!--<p class="error"></p>-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="common mb-3">
                                        ...
                                        <input type="text" class="form-control common__content" name="phone"
                                    ...
                                    <div class="common mb-3">
                                        ...
                                        <input type="date" class="form-control common__content" name="dob" value="${account.accDoB}" />
                                        <!-- <p class="error">Số điện thoại không được để trống</p> -->
                                    </div>

                                    <div class="mb-3 btn-button">
