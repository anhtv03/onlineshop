...
<html lang="en">
            ...
            <div class="ms-content-wrapper">
                <div class="row">
                            ...
                            <div class="ms-panel-body">
                                ...
                                <div id="arrowSlider" class="ms-arrow-slider carousel slide" data-ride="carousel" data-interval="false">
                                    <div class="carousel-inner">
                                        ...
                                        <img class="d-block w-100 " id="imagePreview0" src="#" alt=" Slider" style="height: 550px;">

                                    </div>
                                    <ol class="carousel-indicators" style="overflow: hidden;">
                                        <li data-target="#imagesSlider" data-slide-to="0"><img id="imagePreview0" src="#" style="max-width: 100%;"></li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        <div class="ms-panel ms-panel-fh">
                            <div class="ms-panel-body">
                                ...
                                <table class="table ms-profile-information">
                                    ...
                                    <form action="mkt_addslider" method="post" enctype="multipart/form-data">


                                        <input type="hidden" name="newsId" value="${n.newsId}"/>
                                        <input type="hidden" name="cateNewsId" value="${cateNewsId}"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" type="text" name="sliderTitle" placeholder="Nhập tiêu đề" value="${sliderTitle}" required>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="custom-file">
                                                    <input type="file" accept="image/*" class="custom-file-input" name="proImgBanner" onchange="previewImage(event, 'imagePreview0')" required>
                        ...
                        <div class="ms-panel ms-panel-fh">                            
                            <div class="ms-panel-body">
                                ...
                                <div class="input-group" style="margin-top:-20px;">
                                    ...
                                    <textarea class="form-control" aria-label="With textarea" name="sliderDescription" style="height: 150px!important;" required>${sliderDescription}</textarea>
                                </div>
                            ...
                            <div class="ms-quick-stats" style="margin-bottom:40px;">
                                <div class="ms-stats-grid">
                                    ...
                                    <p class="ms-text-dark"><input class="form-control my-1" style="width: 15%;height: 30%; margin: 0 auto; text-align: center;font-weight: bold" type="hidden" name="sliderView" value="0" readonly></p>
                                    <!--<span class="badge badge-pill badge-primary">Lượt xem</span>-->
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 text-center">
                        <button type="submit" class="btn btn-success mx-5">Thêm Slider</button>
                    </div>
    ...
    <script>
                                                        ...
                                                        // Lưu trữ dữ liệu vào localStorage trước khi tải lại trang
...
// Khôi phục dữ liệu từ localStorage sau khi trang được tải lại
