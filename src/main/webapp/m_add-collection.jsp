    ...
    <head>
        ...
        <script>
            document.getElementById('button').addEventListener('click', function (event) {
                event.preventDefault(); // Ngăn chặn hành vi mặc định của button (nếu có)

                // Lấy giá trị từ các input trong form1
                var input1Value = document.getElementById('input1').value;
                var input2Value = document.getElementById('input2').value;

                // Gán giá trị vào các input trong form2
                document.getElementById('input3').value = input1Value;
                document.getElementById('input4').value = input2Value;


                // Nộp form2
                document.getElementById('submitAdd').submit();
            });
        </script>
        ...
        <main class="body-content">
            ...
            <div class="ms-content-wrapper">
                <div class="row">
                    ...
                    <div class="my-3 mx-4" ><a href="mkt_sliderlist?cateNewsId=2"><i class="fa fa-chevron-circle-left" style="font-size: 2rem;" aria-hidden="true"></i></a></div>
                    <div class="col-md-12">
                        <div class="ms-panel">
                            <c:set var="n" value="${news}"/>

                            <div class="ms-panel-header">
                                <h6>Thêm bộ sưu tập</h6>
                            </div>
                                ...
                                <table class="table ms-profile-information">
                                    ...
                                    <form action="mkt_addcollection" method="post">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" type="text" name="collectionTitle" id="input1" placeholder="Nhập tiêu đề">
                                                <div><h6 class="text-danger text-center">${errorTitle}</h6></div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select class="form-control" name="collectionStatus" id="input2">
                                                    <option class="text-success" value="on" ${collectionStatus eq checkon ? "selected" : ""}>Hoạt động</option>            
                                                    <option class="text-danger" " value="off" ${collectionStatus eq checkoff ? "selected" : ""}>Dừng bán</option>
                                                </select>
                                            </td>
                                        </tr>
                            ...
                            <div class="ms-panel-body">
                                ...
                                <div class="chooseProAndSlider--fixUI col-lg-12 my-3">
                                    <div class="input-group col-lg-6 justify-content-center">
                                        <button type="submit" class="btn btn-outline-info" name="typeCollection" value="chooseSlider">Chọn slider</button>

                                    </div>
                                    <div class="input-group col-lg-6 justify-content-center border-left">
                                        <button type="submit" class="btn btn-outline-info" name="typeCollection" value="chooseProduct">Chọn sản phẩm</button>
                                    </div>
                                ...
                                <div><h6 class="text-danger text-center">${errorProduct}</h6></div>
                                    ...
                                    <c:if test="${listSelectedProduct ne null}">
                                    <!--<form id="handlepro" action="mkt_addcollection" method="post">-->
                                    <div class="col-lg-12 text-center">
                                        <button  name="typeCollection" value="reviewListSel" class="btn btn-info mx-5">Danh sách sản phẩm đã chọn</button>
                                    </div>
                    ...
                    <div class="col-lg-12 text-center">
                        <!--<form  action="mkt_addcollection" method="post">-->
                        <button type="submit" name="typeCollection" value="submitAdd" class="btn btn-success mx-5">Thêm bộ sưu tập</button>
<!--                            <input type="hidden" name="collectionStatus" value="${collectionStatus}"/>
                        <input type="hidden" name="collectionTitle" value="${collectionTitle}"/>
                        <input type="hidden" name="newsId" value="${newsId}"/>
                        <input type="hidden" name="listSelectedProduct" value="${listSelectedProduct}"/>-->
