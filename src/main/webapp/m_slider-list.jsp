                        ...
                        <div class="ms-panel">
                            <c:if test="${typeCollection ne null}">
                                <div class="ms-panel-header">
                                    <h6 class="text-center" >Chọn Slider cho bộ sưu tập</h6>
                                </div>
                            </c:if>
                            <c:if test="${typeCollection eq null}">
                                <div class="ms-panel-header">
                                    <h6 class="text-center">Danh sách Slider</h6>
                                </div>
                            </c:if>
                                                ...
                                                <c:if test="${typeCollection eq null}">
                                                    ...
                                                    <div class="mx-3">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <a class="dropdown-item" href="mkt_sliderlist?cateNewsId=2&sliderStatus=&searching=${searching}&sortByView=${sortByView}">Tất cả</a>  
                                                            <a class="dropdown-item" href="mkt_sliderlist?cateNewsId=2&sliderStatus=on&searching=${searching}&sortByView=${sortByView}" style="color: green;">Đang hoạt động</a>  
                                                            <a class="dropdown-item" href="mkt_sliderlist?cateNewsId=2&sliderStatus=off&searching=${searching}&sortByView=${sortByView}" style="color: #dc3545;">Đã dừng</a>  
                                        ...
                                        <table class="table table-hover w-100 table-red text-center">
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th  scope="col" style="width: 40%">Tên Slider</th>
                                                    ...
                                                    <tr class="my-5">
                                                        ...
                                                        <td class="">
                                                            <div class="title">
                                                                <div class="title__img">
                                                                    <img style="" src="${ln.newsImgUrl}" alt="people">&nbsp;
                                                                </div>
                                                                <div class="title_content">${ln.newsTitle}</div>
                                                            </div>
                                                        </td>

                                                        <td class="align-middle font-italic">
                                                            <c:set var="accountId" value="${ln.emId}" />
                                                            <fmt:parseNumber var="IdParsed" type="number" value="${ln.emId}" />
                                                            <c:set var="accountName" value="${AccCus.getAccByEmpId(IdParsed).accName}" />
                                                            <c:out value="${accountName}" />
                                                        </td>
                                                        <td class="align-middle">${ln.newsCreatedDate}</td>
                                                        <%--<c:if test="${ln.newsUpdateDate eq null}">--%>
                                                        <td class="align-middle">${ln.newsUpdateDate}</td>
                                                        <%--</c:if>--%>
                                                        <c:set var="check" value="on" />
                                                        <c:choose>  
                                                            <c:when test="${ln.newsStatus == check}">
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <span>
                                                                ...
                                                                <button type="submit" name="newsId" value="${ln.newsId}" class="icon--button"><i class="fas fa-eye" style="color: #b1a9a9; font-size: 14px;"></i></button>
                                                ...
                                                <ul class="pagination justify-content-lg-end  mt-5">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <li class="page-item ${paging eq "previous" && numberPage != 3 && numberPage != 2?"active":""}">
                                                                <a class="page-link" href="mkt_sliderlist?numberPage=${(numberPage - 1)}&paging=previous&cateNewsId=2&sliderStatus=${sliderStatus}&searching=${searching}&sortByView=${sortByView}">Trang trước</a>
                                                            </li>
                                                        </c:otherwise>
                                                    </c:choose>
                                                    <c:if test="${endPage == 0}">
                                                    ...
                                                    <c:if test="${endPage > 0}">
                                                        <li class="page-item ${numberPage == 1?"active":""}">
                                                            <a class="page-link" href="mkt_sliderlist?numberPage=1&cateNewsId=2&sliderStatus=${sliderStatus}&searching=${searching}&sortByView=${sortByView}">1</a>
                                                        </li>
                                                    </c:if>

                                                    <c:if test="${endPage > 1}">
                                                        <li class="page-item ${numberPage == 2?"active":""}">
                                                            <a class="page-link" href="mkt_sliderlist?numberPage=2&cateNewsId=2&sliderStatus=${sliderStatus}&searching=${searching}&sortByView=${sortByView}">2</a>
                                                        </li>
                                                    </c:if>
                                                    <c:if test="${endPage > 2}">
                                                        ...
                                                        <li class="page-item ${numberPage == 3?"active":"}"}">
                                                            ...
                                                            <a class="page-link" href="mkt_sliderlist?numberPage=3&cateNewsId=2&sliderStatus=${sliderStatus}&searching=${searching}&sortByView=${sortByView}">3</a>
                                                        </li>
                                                    </c:if>
                                                    <c:if test="${numberPage > 3}">
                                                        ...
                                                        <li class="page-item ${numberPage == numberPage?"active":""}">
                                                            <a class="page-link" href="mkt_productlist?numberPage=${numberPage}&cateNewsId=2&sliderStatus=${sliderStatus}&searching=${searching}&sortByView=${sortByView}">${numberPage}</a>
                                                        </li>
                                                    </c:if>
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <li class="page-item">
                                                                <a class="page-link" href="mkt_sliderlist?numberPage=${(numberPage + 1)}&paging=next&cateNewsId=2&sliderStatus=${sliderStatus}&searching=${searching}&sortByView=${sortByView}">Trang sau</a>
                                                            </li>
                                                        </c:otherwise>
                                                    </c:choose>
