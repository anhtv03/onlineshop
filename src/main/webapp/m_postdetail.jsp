...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            function doDelete(id) {
                if (confirm("Bạn có chắc chắn xóa bài viết này?")) {
                    window.location = "mkt_deletepost?newsId=" + id;
                }
            }
        </script>
    </head>
    ...
    <body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
     <!-- Sidebar Navigation Left Begin -->
            ...
            <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
                ...
                <li class="menu-item">
                    ...
                    <ul id="slider" class="collapse" aria-labelledby="slider" data-parent="#side-nav-accordion">
                        <li> <a href="mkt_postlist" class="active">Danh sách bài đăng</a>
                        </li>
                    ...
                    <div class="col-md-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb pl-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">${requestScope.dNews.newsTitle}</li>
                            </ol>
                        </nav>
                        <!-- Breadcrumb End -->
                        ...
                        <div class="ms-panel">
                            <div class="ms-panel-header">
                                <h6>Nội dung:${requestScope.dNews.newsTitle}</h6>
                            </div>
                            <div class="ms-panel-body">
                                <div class="table-responsive">
                                    <div>
                                        ${requestScope.dNews.newsDescription}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 text-center">
                            ...
                            <button onclick="editPost()" class="btn btn-success mx-5">Chỉnh sửa</button>
                            <button type="button" onclick="doDelete('${requestScope.dNews.newsId}')" class="btn btn-danger mx-5">Xóa</button>
                        </div>
                        <!-- Table Product -->
        ...
        <script>
                                function editPost() {
                                    // Lấy newsId từ requestScope.dNews.newsId (nếu đã được khai báo trước)
                                    var newsId = "${requestScope.dNews.newsId}";

                                    // Chuyển hướng người dùng đến trang chỉnh sửa với newsId
                                    window.location.href = "mkt_postedit?newsId=" + newsId;
                                }
        </script>
    </body>
